...
public class AddUserToBoardCtrl {
    ...
    @RequestMapping(value = "/static/addUser")
    public void addUserToBoard(HttpServletRequest req, @RequestBody String json) throws JsonParseException, JsonMappingException, IOException{
